...
class NO3D_AddonPreferences(AddonPreferences):
    ...
    view_distribute_axis_x_key: EnumProperty(name="World X Lock", items=VIEW_ALIGN_KEY_ITEMS, default="X")
    view_distribute_axis_y_key: EnumProperty(name="World Y Lock", items=VIEW_ALIGN_KEY_ITEMS, default="C")
    view_distribute_axis_z_key: EnumProperty(name="World Z Lock", items=VIEW_ALIGN_KEY_ITEMS, default="Z")
